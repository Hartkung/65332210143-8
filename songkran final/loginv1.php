            ...
            <div class="u-custom-menu u-nav-container">
                <ul class="u-nav u-unstyled u-nav-1">
                    <li class="u-nav-item"><a
                                ...
                                href="HomeV1.php" style="padding: 10px 20px;">หน้าแรก</a>
                    </li>
                    <li class="u-nav-item"><a
                                class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
                                href="registerV1.php" style="padding: 10px 20px;">สมัครสมาชิก</a>
                    </li>
                    <li class="u-nav-item"><a
                                class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
                                href="loginv1.php" style="padding: 10px 20px;">เข้าสู่ระบบ</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                    <div class="u-inner-container-layout u-sidenav-overflow">
                        ...
                        <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="HomeV1.php">หน้าแรก</a>
                            </li>
                            <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                      href="registerV1.php">สมัครสมาชิก</a>
                            </li>
                            <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                      href="loginv1.php">เข้าสู่ระบบ</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="custom-expanded u-clearfix u-custom-html u-custom-html-1">
            ...
            <form action="./qurry.php" method="post">
                <div class="container">
                    ...
                    <hr>
                    <p>ยังไม่มี Account หรือไม่? <a href="registerV1.php">สมัครสมาชิก</a>.
                    </p>
