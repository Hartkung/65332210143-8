...
<link rel="stylesheet" href="register.css" media="screen">
  ...
  <body data-path-to-root="./" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-sticky u-sticky-6357 u-header" id="sec-b86e" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><a href="Home.php" class="u-image u-logo u-image-1" data-image-width="360" data-image-height="306">
          ...
          if (isset($_SESSION['message_user'])) {
              if ($_SESSION['message_user'] = "Username นี้มีอยู่ในระบบแล้ว") {
                  ?>
                  <script>
                      Swal.fire({
                          icon: 'error',
                          title: 'Oops...',
                          text: 'Username นี้มีอยู่ในระบบแล้ว!'
                      });
                  </script>
                  <?php
          ...
          if (isset($_SESSION['message_pass'])) {
              if ($_SESSION['message_pass'] = "รหัสผ่านไม่ตรงกัน") {
                  ?>
                  <script>
                      Swal.fire({
                          icon: 'error',
  ...
  text-align: center;
          ...
          <form action="./register_data.php"method="post">
              ...
              <div class="container signin">
                  <p>มี Account อยู่แล้วหรือไม่? <a href="login.php">เข้าสู่ระบบ</a>.
                  </p>
              </div>
          </form>
        </div>
