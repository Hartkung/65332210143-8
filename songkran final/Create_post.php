  ...
  <body data-path-to-root="./" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-sticky u-sticky-6357 u-header" id="sec-b86e" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><a href="Home.php" class="u-image u-logo u-image-1" data-image-width="360" data-image-height="306" title="Home">
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-d431" data-image-width="550" data-image-height="550">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-title u-text-1">สร้างโพส</h1>
        <div class="custom-expanded u-form u-form-1">
          <form action="./Create_post_data.php" method="post" >
            <div class="u-form-group u-form-name u-label-top u-form-group-1">
              <label for="title" class="u-label">หัวข้อ</label>
              <input type="text" placeholder="หัวข้อ" id="title" name="title" class="u-input u-input-rectangle" required="">
            </div>
            <div class="u-form-group u-form-message u-label-top">
              <label for="content" class="u-label">เนื้อหา</label>
              <textarea placeholder="เนื้อหา" rows="4" cols="50" id="content" name="content" class="u-input u-input-rectangle" required=""></textarea>
            </div>
